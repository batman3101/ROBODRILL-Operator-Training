...
![드라이런과 싱글블록 CNC 화면 및 조작 패널 mockup](../../assets/diagrams/control/level1_item13_control.svg)

<p class="caption">그림 13-2. 드라이런과 싱글블록 수업에서 읽어야 할 CNC 화면 값과 확인해야 할 조작 패널 위치를 함께 표시한 mockup.</p>
...
![드라이런과 싱글블록 기능 학습 도해](../../assets/diagrams/training/level1_item13_study.svg)

<p class="caption">그림 13-3. 드라이런과 싱글블록의 조작 순서와 실제 움직임을 함께 보는 학습용 도해.</p>
