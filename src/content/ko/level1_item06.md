...
![좌표계 이해 CNC 화면 및 조작 패널 mockup](../../assets/diagrams/control/level1_item06_control.svg)

<p class="caption">그림 6-2. 좌표계 이해 수업에서 읽어야 할 CNC 화면 값과 확인해야 할 조작 패널 위치를 함께 표시한 mockup.</p>
...
<p class="caption">그림 6-3. 좌표계 이해의 조작 순서와 실제 움직임을 함께 보는 학습용 도해.</p>
