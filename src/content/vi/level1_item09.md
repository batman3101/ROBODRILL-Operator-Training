...
<p class="subtitle">Level 1 - Item 09<br>Thay dao</p>
</div>
<div class="cover-meta">
<strong>Đối tượng</strong><span>Người vận hành mới, nhân viên chất lượng và nhân viên bảo trì thiết bị</span>
<strong>Mục tiêu</strong><span>Hiểu vùng hoạt động ATC, mã T, kiểm tra dao trên trục chính và dao trong ổ dao.</span>
...
Mục này giúp học viên mới hiểu và giải thích an toàn nội dung Thay dao. Hiểu vùng hoạt động ATC, mã T, kiểm tra dao trên trục chính và dao trong ổ dao. Người vận hành không chỉ học tên nút mà phải đọc trạng thái máy, dự đoán hành động tiếp theo và nhận biết vị trí nguy hiểm trước khi thao tác. Mọi thao tác được thực hiện theo thứ tự kiểm tra, chọn, thực hiện, quan sát và ghi lại.
...
- Hiểu vùng hoạt động ATC, mã T, kiểm tra dao trên trục chính và dao trong ổ dao.
...
| --- | --- | --- |
| Hiểu | Giải thích mục đích của Thay dao | Dùng ít nhất 3 thuật ngữ chính |
...
![Hình tham khảo Thay dao](../../assets/images/fanuc_robodrill_official_tool_changer.webp)

<p class="caption">Hình 9-1. Hình tham khảo cho bài Thay dao. Nguồn và quyền sử dụng được ghi trong tài liệu nguồn hình ảnh.</p>
...
![Mockup màn hình CNC và bảng điều khiển cho Thay dao](../../assets/diagrams/control/level1_item09_control.svg)

<p class="caption">Hình 9-2. Mockup màn hình CNC và bảng điều khiển cần đọc trong bài Thay dao.</p>
...
![Sơ đồ học chức năng Thay dao](../../assets/diagrams/training/level1_item09_study.svg)

<p class="caption">Hình 9-3. Sơ đồ học cho Thay dao, gồm thứ tự thao tác và chuyển động thật.</p>
...
Điểm cốt lõi của Thay dao không chỉ là nhớ quy trình, mà là hiểu vì sao quy trình đó tồn tại. ROBODRILL là máy nhỏ và nhanh, nên một lần bỏ sót kiểm tra cũng có thể dẫn tới va chạm hoặc lỗi chất lượng. Vì vậy ở cấp cơ bản, thói quen quan sát an toàn quan trọng hơn tốc độ thao tác.
...
4. Tìm nút hoặc menu cần dùng cho Thay dao và nói tên của nó.
...
Thực hành: Tại vị trí đào tạo do giảng viên chỉ định, học viên nói to quy trình Thay dao, sau đó thực hiện từng bước và dừng lại sau mỗi bước. Sau mỗi bước, học viên mô tả trạng thái màn hình và trạng thái máy thật.
</div>
...
3. Nói 5 hạng mục cần kiểm tra trước Thay dao.
...
1. Việc đầu tiên cần kiểm tra trước Thay dao là gì?
...
1. Viết 5 hạng mục cần kiểm tra trước Thay dao.
...
Giảng viên không chỉ kiểm tra học viên có nhớ quy trình hay không. Cần kiểm tra học viên có giải thích được vì sao phải dừng và xác nhận ở từng bước hay không. Thay dao liên kết với bài tiếp theo, nên sau thực hành phải luôn để lại câu hỏi và ghi nhận.

## Liên kết với mục tiếp theo

Bài tiếp theo là 10 Bù dao Tool Offset. Thói quen kiểm tra trạng thái, dừng an toàn và ghi nhận trong bài này sẽ tiếp tục được dùng ở bài sau.
