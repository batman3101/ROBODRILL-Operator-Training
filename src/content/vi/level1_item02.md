...
![Mockup màn hình CNC và bảng điều khiển cho Bật và tắt nguồn](../../assets/diagrams/control/level1_item02_control.svg)

<p class="caption">Hình 2-2. Mockup màn hình CNC và bảng điều khiển cần đọc trong bài Bật và tắt nguồn.</p>
...
<p class="caption">Hình 2-3. Sơ đồ học cho Bật và tắt nguồn, gồm thứ tự thao tác và chuyển động thật.</p>
