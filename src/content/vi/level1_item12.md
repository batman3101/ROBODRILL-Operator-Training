...
<p class="subtitle">Level 1 - Item 12<br>Cấu trúc chương trình cơ bản</p>
</div>
<div class="cover-meta">
<strong>Đối tượng</strong><span>Người vận hành mới, nhân viên chất lượng và nhân viên bảo trì thiết bị</span>
<strong>Mục tiêu</strong><span>Đọc được block, mã G, mã M, chú thích và dòng khởi động an toàn.</span>
...
![Hình tham khảo Cấu trúc chương trình cơ bản](../../assets/diagrams/training_flow.svg)

<p class="caption">Hình 12-1. Hình tham khảo cho bài Cấu trúc chương trình cơ bản. Nguồn và quyền sử dụng được ghi trong tài liệu nguồn hình ảnh.</p>
...
![Mockup màn hình CNC và bảng điều khiển cho Cấu trúc chương trình cơ bản](../../assets/diagrams/control/level1_item12_control.svg)

<p class="caption">Hình 12-2. Mockup màn hình CNC và bảng điều khiển cần đọc trong bài Cấu trúc chương trình cơ bản.</p>
...
![Sơ đồ học chức năng Cấu trúc chương trình cơ bản](../../assets/diagrams/training/level1_item12_study.svg)

<p class="caption">Hình 12-3. Sơ đồ học cho Cấu trúc chương trình cơ bản, gồm thứ tự thao tác và chuyển động thật.</p>
