...
<p class="subtitle">Level 1 - Item 07<br>Cách dùng MDI</p>
</div>
<div class="cover-meta">
<strong>Đối tượng</strong><span>Người vận hành mới, nhân viên chất lượng và nhân viên bảo trì thiết bị</span>
<strong>Mục tiêu</strong><span>Hiểu quy trình kiểm tra và rủi ro khi nhập lệnh ngắn trực tiếp bằng MDI.</span>
...
Mục này giúp học viên mới hiểu và giải thích an toàn nội dung Cách dùng MDI. Hiểu quy trình kiểm tra và rủi ro khi nhập lệnh ngắn trực tiếp bằng MDI. Người vận hành không chỉ học tên nút mà phải đọc trạng thái máy, dự đoán hành động tiếp theo và nhận biết vị trí nguy hiểm trước khi thao tác. Mọi thao tác được thực hiện theo thứ tự kiểm tra, chọn, thực hiện, quan sát và ghi lại.
...
- Hiểu quy trình kiểm tra và rủi ro khi nhập lệnh ngắn trực tiếp bằng MDI.
...
| --- | --- | --- |
| Hiểu | Giải thích mục đích của Cách dùng MDI | Dùng ít nhất 3 thuật ngữ chính |
...
Thời điểm nguy hiểm nhất trong Cách dùng MDI là khi người vận hành chạy bước tiếp theo mà chưa đọc trạng thái máy. Trục chính, chuyển động trục, thay dao, nhập tọa độ và chạy chương trình đều có thể biến thao tác trên màn hình thành chuyển động thật. Học viên phải nhìn đồng thời số trên màn hình và vị trí dao thật.
...
![Hình tham khảo Cách dùng MDI](../../assets/images/fanuc_robodrill_official_panel.webp)

<p class="caption">Hình 7-1. Hình tham khảo cho bài Cách dùng MDI. Nguồn và quyền sử dụng được ghi trong tài liệu nguồn hình ảnh.</p>
...
Điểm cốt lõi của Cách dùng MDI không chỉ là nhớ quy trình, mà là hiểu vì sao quy trình đó tồn tại. ROBODRILL là máy nhỏ và nhanh, nên một lần bỏ sót kiểm tra cũng có thể dẫn tới va chạm hoặc lỗi chất lượng. Vì vậy ở cấp cơ bản, thói quen quan sát an toàn quan trọng hơn tốc độ thao tác.
...
4. Tìm nút hoặc menu cần dùng cho Cách dùng MDI và nói tên của nó.
...
Thực hành: Tại vị trí đào tạo do giảng viên chỉ định, học viên nói to quy trình Cách dùng MDI, sau đó thực hiện từng bước và dừng lại sau mỗi bước. Sau mỗi bước, học viên mô tả trạng thái màn hình và trạng thái máy thật.
</div>
...
3. Nói 5 hạng mục cần kiểm tra trước Cách dùng MDI.
...
1. Việc đầu tiên cần kiểm tra trước Cách dùng MDI là gì?
...
1. Viết 5 hạng mục cần kiểm tra trước Cách dùng MDI.
...
Giảng viên không chỉ kiểm tra học viên có nhớ quy trình hay không. Cần kiểm tra học viên có giải thích được vì sao phải dừng và xác nhận ở từng bước hay không. Cách dùng MDI liên kết với bài tiếp theo, nên sau thực hành phải luôn để lại câu hỏi và ghi nhận.

## Liên kết với mục tiếp theo

Bài tiếp theo là 08 Gọi chương trình. Thói quen kiểm tra trạng thái, dừng an toàn và ghi nhận trong bài này sẽ tiếp tục được dùng ở bài sau.
