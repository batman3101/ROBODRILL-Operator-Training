...
<p class="subtitle">Level 1 - Item 20<br>Thực hành gia công đầu tiên</p>
</div>
<div class="cover-meta">
<strong>Đối tượng</strong><span>Người vận hành mới, nhân viên chất lượng và nhân viên bảo trì thiết bị</span>
<strong>Mục tiêu</strong><span>Thực hiện tổng hợp từ kiểm tra an toàn, dry run, cắt lần đầu, kiểm tra chất lượng đến ghi nhận.</span>
...
# 20. Thực hành gia công đầu tiên

Mục này giúp học viên mới hiểu và giải thích an toàn nội dung Thực hành gia công đầu tiên. Thực hiện tổng hợp từ kiểm tra an toàn, dry run, cắt lần đầu, kiểm tra chất lượng đến ghi nhận. Người vận hành không chỉ học tên nút mà phải đọc trạng thái máy, dự đoán hành động tiếp theo và nhận biết vị trí nguy hiểm trước khi thao tác. Mọi thao tác được thực hiện theo thứ tự kiểm tra, chọn, thực hiện, quan sát và ghi lại.
...
- Thực hiện tổng hợp từ kiểm tra an toàn, dry run, cắt lần đầu, kiểm tra chất lượng đến ghi nhận.
...
| --- | --- | --- |
| Hiểu | Giải thích mục đích của Thực hành gia công đầu tiên | Dùng ít nhất 3 thuật ngữ chính |
...
Thời điểm nguy hiểm nhất trong Thực hành gia công đầu tiên là khi người vận hành chạy bước tiếp theo mà chưa đọc trạng thái máy. Trục chính, chuyển động trục, thay dao, nhập tọa độ và chạy chương trình đều có thể biến thao tác trên màn hình thành chuyển động thật. Học viên phải nhìn đồng thời số trên màn hình và vị trí dao thật.
...
![Hình tham khảo Thực hành gia công đầu tiên](../../assets/images/fanuc_robodrill_real_wikimedia.jpg)

<p class="caption">Hình 20-1. Hình tham khảo cho bài Thực hành gia công đầu tiên. Nguồn và quyền sử dụng được ghi trong tài liệu nguồn hình ảnh.</p>
...
![Mockup màn hình CNC và bảng điều khiển cho Thực hành gia công đầu tiên](../../assets/diagrams/control/level1_item20_control.svg)

<p class="caption">Hình 20-2. Mockup màn hình CNC và bảng điều khiển cần đọc trong bài Thực hành gia công đầu tiên.</p>
...
![Sơ đồ học chức năng Thực hành gia công đầu tiên](../../assets/diagrams/training/level1_item20_study.svg)

<p class="caption">Hình 20-3. Sơ đồ học cho Thực hành gia công đầu tiên, gồm thứ tự thao tác và chuyển động thật.</p>
...
Điểm cốt lõi của Thực hành gia công đầu tiên không chỉ là nhớ quy trình, mà là hiểu vì sao quy trình đó tồn tại. ROBODRILL là máy nhỏ và nhanh, nên một lần bỏ sót kiểm tra cũng có thể dẫn tới va chạm hoặc lỗi chất lượng. Vì vậy ở cấp cơ bản, thói quen quan sát an toàn quan trọng hơn tốc độ thao tác.
...
4. Tìm nút hoặc menu cần dùng cho Thực hành gia công đầu tiên và nói tên của nó.
...
Thực hành: Tại vị trí đào tạo do giảng viên chỉ định, học viên nói to quy trình Thực hành gia công đầu tiên, sau đó thực hiện từng bước và dừng lại sau mỗi bước. Sau mỗi bước, học viên mô tả trạng thái màn hình và trạng thái máy thật.
</div>
...
3. Nói 5 hạng mục cần kiểm tra trước Thực hành gia công đầu tiên.
...
1. Việc đầu tiên cần kiểm tra trước Thực hành gia công đầu tiên là gì?
...
1. Viết 5 hạng mục cần kiểm tra trước Thực hành gia công đầu tiên.
...
Giảng viên không chỉ kiểm tra học viên có nhớ quy trình hay không. Cần kiểm tra học viên có giải thích được vì sao phải dừng và xác nhận ở từng bước hay không. Thực hành gia công đầu tiên liên kết với bài tiếp theo, nên sau thực hành phải luôn để lại câu hỏi và ghi nhận.

## Liên kết với mục tiếp theo

Bài tiếp theo là Ôn tập tổng hợp Level 1. Thói quen kiểm tra trạng thái, dừng an toàn và ghi nhận trong bài này sẽ tiếp tục được dùng ở bài sau.
