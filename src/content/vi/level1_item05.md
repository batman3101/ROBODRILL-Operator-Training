...
<p class="subtitle">Level 1 - Item 05<br>Di chuyển bằng tay quay HANDLE</p>
</div>
<div class="cover-meta">
<strong>Đối tượng</strong><span>Người vận hành mới, nhân viên chất lượng và nhân viên bảo trì thiết bị</span>
<strong>Mục tiêu</strong><span>Nắm cách chọn hệ số tay quay và tiếp cận tinh để giảm nguy cơ va chạm.</span>
...
# 05. Di chuyển bằng tay quay HANDLE

Mục này giúp học viên mới hiểu và giải thích an toàn nội dung Di chuyển bằng tay quay HANDLE. Nắm cách chọn hệ số tay quay và tiếp cận tinh để giảm nguy cơ va chạm. Người vận hành không chỉ học tên nút mà phải đọc trạng thái máy, dự đoán hành động tiếp theo và nhận biết vị trí nguy hiểm trước khi thao tác. Mọi thao tác được thực hiện theo thứ tự kiểm tra, chọn, thực hiện, quan sát và ghi lại.
...
- Nắm cách chọn hệ số tay quay và tiếp cận tinh để giảm nguy cơ va chạm.
...
| --- | --- | --- |
| Hiểu | Giải thích mục đích của Di chuyển bằng tay quay HANDLE | Dùng ít nhất 3 thuật ngữ chính |
...
![Hình tham khảo Di chuyển bằng tay quay HANDLE](../../assets/diagrams/axis_coordinate.svg)

<p class="caption">Hình 5-1. Hình tham khảo cho bài Di chuyển bằng tay quay HANDLE. Nguồn và quyền sử dụng được ghi trong tài liệu nguồn hình ảnh.</p>
...
![Mockup màn hình CNC và bảng điều khiển cho Di chuyển bằng tay quay HANDLE](../../assets/diagrams/control/level1_item05_control.svg)

<p class="caption">Hình 5-2. Mockup màn hình CNC và bảng điều khiển cần đọc trong bài Di chuyển bằng tay quay HANDLE.</p>
...
![Sơ đồ học chức năng Di chuyển bằng tay quay HANDLE](../../assets/diagrams/training/level1_item05_study.svg)

<p class="caption">Hình 5-3. Sơ đồ học cho Di chuyển bằng tay quay HANDLE, gồm thứ tự thao tác và chuyển động thật.</p>
...
Điểm cốt lõi của Di chuyển bằng tay quay HANDLE không chỉ là nhớ quy trình, mà là hiểu vì sao quy trình đó tồn tại. ROBODRILL là máy nhỏ và nhanh, nên một lần bỏ sót kiểm tra cũng có thể dẫn tới va chạm hoặc lỗi chất lượng. Vì vậy ở cấp cơ bản, thói quen quan sát an toàn quan trọng hơn tốc độ thao tác.
...
4. Tìm nút hoặc menu cần dùng cho Di chuyển bằng tay quay HANDLE và nói tên của nó.
...
Thực hành: Tại vị trí đào tạo do giảng viên chỉ định, học viên nói to quy trình Di chuyển bằng tay quay HANDLE, sau đó thực hiện từng bước và dừng lại sau mỗi bước. Sau mỗi bước, học viên mô tả trạng thái màn hình và trạng thái máy thật.
</div>
...
3. Nói 5 hạng mục cần kiểm tra trước Di chuyển bằng tay quay HANDLE.
...
1. Việc đầu tiên cần kiểm tra trước Di chuyển bằng tay quay HANDLE là gì?
...
1. Viết 5 hạng mục cần kiểm tra trước Di chuyển bằng tay quay HANDLE.
...
Giảng viên không chỉ kiểm tra học viên có nhớ quy trình hay không. Cần kiểm tra học viên có giải thích được vì sao phải dừng và xác nhận ở từng bước hay không. Di chuyển bằng tay quay HANDLE liên kết với bài tiếp theo, nên sau thực hành phải luôn để lại câu hỏi và ghi nhận.

## Liên kết với mục tiếp theo

Bài tiếp theo là 06 Hiểu hệ tọa độ. Thói quen kiểm tra trạng thái, dừng an toàn và ghi nhận trong bài này sẽ tiếp tục được dùng ở bài sau.
